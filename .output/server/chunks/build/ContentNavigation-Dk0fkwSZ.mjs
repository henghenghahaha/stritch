import { f as useState, V as useContentDisabled, S as useAsyncData, W as fetchContentNavigation, x as __nuxt_component_0$8 } from './server.mjs';
import { defineComponent, toRefs, computed, useSlots, useSSRContext, h } from 'vue';
import { k as hash } from '../runtime.mjs';
...
const ContentNavigation = defineComponent({
  ...
  render(ctx) {
    ...
    const renderLink = (link) => h(__nuxt_component_0$8, { to: link._path }, () => link.title);
...
//# sourceMappingURL=ContentNavigation-Dk0fkwSZ.mjs.map
