import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, shallowRef, onServerPrefetch, defineComponent, provide, createElementBlock, defineAsyncComponent, effectScope, computed, getCurrentScope, h as h$1, unref, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, useAttrs, toValue as toValue$1, onMounted, cloneVNode, onUnmounted, Teleport, reactive, normalizeClass, mergeProps, useSlots, resolveComponent, onScopeDispose, readonly, withAsyncContext, createVNode, resolveDynamicComponent, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createTextVNode, createApp, onErrorCaptured, isReadonly, createSlots, renderList, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, i as createError$1, N as defuFn, O as klona, z as defu, P as withLeadingSlash, Q as joinURL, y as withoutTrailingSlash, l as hash$2, R as parseQuery, S as createDefu, T as isEqual, U as withBase, V as createHooks, W as parse, X as getRequestHeader, Y as hasProtocol, Z as isScriptProtocol, D as withQuery, n as destr, _ as setCookie, a0 as getCookie, a1 as deleteCookie, a2 as sanitizeStatusCode, H as withTrailingSlash, p as parseURL, w as toRouteMatcher, x as createRouter$1, A as withoutBase } from '../runtime.mjs';
...
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderAttr, ssrRenderSuspense, ssrRenderTeleport, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
const component_45stubjj4EgIh8f9 = {};
const _routes = [
  {
    name: "course",
    path: "/course",
    component: () => import('./course-DY9G9qNR.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "dist",
    path: "/dist",
    component: () => import('./dist-BIP6d53I.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CV-2LuCD.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "inquery",
    path: "/inquery",
    component: () => import('./inquery-BCFvv025.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "major",
    path: "/major",
    component: () => import('./major-BE7e55Vq.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "record-slug",
    path: "/record/:slug()",
    component: () => import('./_slug_-dgleoD-j.mjs').then((m2) => m2.default || m2)
  },
  {
    name: void 0 ,
    path: "/docs",
    component: component_45stubjj4EgIh8f9
  }
];
...
const __nuxt_component_0$8 = /* @__PURE__ */ defineNuxtLink(nuxtLinkDefaults);
...
const LazyCallout = defineAsyncComponent(() => import('./Callout-3ObiOMtE.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyCard = defineAsyncComponent(() => import('./Card-CuymjYxg.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyCardGroup = defineAsyncComponent(() => import('./CardGroup-DK-wMP_t.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyCodeGroup = defineAsyncComponent(() => import('./CodeGroup-C1O84HsZ.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyCollapsible = defineAsyncComponent(() => import('./Collapsible-B5cNgISV.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyField = defineAsyncComponent(() => import('./Field-B3Mhr44T.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyFieldGroup = defineAsyncComponent(() => import('./FieldGroup-Bf2pZMqq.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyShortcut = defineAsyncComponent(() => import('./Shortcut-hkjDzir7.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyTabs = defineAsyncComponent(() => import('./Tabs-BF_YmWfM.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-Chv6cwYi.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseCodeButton = defineAsyncComponent(() => import('./ProseCodeButton-uwip0OgG.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseCodeIcon = defineAsyncComponent(() => import('./ProseCodeIcon-C5Gm-0Xl.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-B7Rl2q28.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-CIm0_ch1.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-KmYZUVA3.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-FdovFOHJ.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DCR-8bE6.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-DKTAyrlt.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-Dk0fkwSZ.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-jxAgTQDg.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-CstRyzM1.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-jDZvWlTO.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-DwQhcMMU.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty-Cip47SHJ.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound-CkdnlFZR.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-BFylpe3p.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-BYgWphWO.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-CaUz9Sbl.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-B8AXl0HS.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-C_HZ2iQh.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-0_Q3XPix.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-CewfGBUJ.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-DuSaVUmE.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Dt1hIz1o.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-viFs4afw.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-BdoqlgJu.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BnQWT6cz.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DH2_CiWW.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-C1UZxj8A.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-Dcc7Emi_.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-Ch8F6lJr.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-DLh5bSYY.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-COJ3zt_r.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-DMtmkzfj.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-Cfqwq7WT.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-BEvraWET.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-CUGimacD.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BY-mfJOr.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const colors_244lXBzhnM = /* @__PURE__ */ defineNuxtPlugin(() => {
  ...
  useNuxtApp();
  const root = computed(() => {
    const primary = config$6[appConfig2.ui.primary];
    const gray = config$6[appConfig2.ui.gray];
    if (!primary) {
    ...
    return `:root {
${Object.entries(primary || config$6.green).map(([key, value]) => `--color-primary-${key}: ${hexToRgb(value)};`).join("\n")}
--color-primary-DEFAULT: var(--color-primary-500);

${Object.entries(gray || config$6.cool).map(([key, value]) => `--color-gray-${key}: ${hexToRgb(value)};`).join("\n")}
}
...
const layouts = {
  auth: () => import('./auth-Cpb0Iyda.mjs').then((m2) => m2.default || m2),
  default: () => import('./default-BdsQBaCi.mjs').then((m2) => m2.default || m2)
};
...
const __nuxt_component_0$6 = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-4847b53f"]]);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["ssrRender", _sfc_ssrRender$8]]);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["ssrRender", _sfc_ssrRender$7]]);
...
const __nuxt_component_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender$6]]);
...
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["ssrRender", _sfc_ssrRender$5]]);
...
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$4]]);
function useToast() {
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender$3]]);
const useColorMode = () => {
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$2]]);
function t$5(e2) {
...
let ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { slots: P2, attrs: s3, expose: h$2 }) {
  ...
  var u2;
  let f2 = (u2 = d2.id) != null ? u2 : `headlessui-popover-button-${I$1()}`, t2 = U("PopoverButton"), o$22 = computed(() => i$3(t2.button));
...
let je = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d2, { attrs: P$1, slots: s3, expose: h2 }) {
  var w2;
  let f2 = (w2 = d2.id) != null ? w2 : `headlessui-popover-panel-${I$1()}`, { focus: t2 } = d2, o$22 = U("PopoverPanel"), y2 = computed(() => i$3(o$22.panel)), v2 = `headlessui-focus-sentinel-before-${I$1()}`, m2 = `headlessui-focus-sentinel-after-${I$1()}`;
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$1]]);
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ULink = __nuxt_component_0$5;
      const _component_UIcon = __nuxt_component_1;
      const _component_UHeaderPopoverLinks = _sfc_main$c;
      if ((_a = __props.links) == null ? void 0 : _a.length) {
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$8;
      const _component_UHeaderLinks = _sfc_main$b;
      const _component_UButton = __nuxt_component_0$4;
      const _component_UAsideLinks = _sfc_main$a;
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UHeader, mergeProps({
        links,
        ui: {
          wrapper: "bg-background/75 backdrop-blur border-b border-gray-200 dark:border-gray-800 -mb-px sticky top-0 z-50 h-35",
          container: "flex items-center justify-between gap-3 h-22"
        }
      }, _attrs), {
        logo: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "margin-top": "8px", "margin-bottom": "8px" })}" class="flex" data-v-8211e999${_scopeId}><img class="headerlogo"${ssrRenderAttr("src", _imports_0)} alt="stritch university" data-v-8211e999${_scopeId}><p style="${ssrRenderStyle({ "margin-top": "28px", "margin-left": "3px", "font-size": "17px", "font-family": "'Times New Roman', Times, serif", "font-weight": "bold" })}" data-v-8211e999${_scopeId}>Cardinal Stritch University</p></div>`);
          } else {
            return [
              createVNode("div", {
                ...
                createVNode("img", {
                  class: "headerlogo",
                  src: _imports_0,
                  alt: "stritch university"
                }),
                createVNode("p", { style: { "margin-top": "28px", "margin-left": "3px", "font-size": "17px", "font-family": "'Times New Roman', Times, serif", "font-weight": "bold" } }, "Cardinal Stritch University")
              ])
            ];
          }
        }),
        right: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UButton, {
              label: "Location",
              color: "gray",
              to: "https://maps.app.goo.gl/8sJqc4st6ZQoXnj3A"
            }, null, _parent2, _scopeId));
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-8211e999"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UContainer = __nuxt_component_0$2;
      const _component_UFooterLinks = _sfc_main$4;
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_UFooter, _attrs, {
    center: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="text-gray-500 dark:text-gray-400 text-sm"${_scopeId}> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Cardinal Stritch University. </p>`);
      } else {
        return [
          createVNode("p", { class: "text-gray-500 dark:text-gray-400 text-sm" }, " © " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " Cardinal Stritch University. ", 1)
        ];
      }
    }),
    _: 1
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Cr1lSS5X.mjs').then((m2) => m2.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-Cr1lSS5X.mjs').then((m2) => m2.generateNavigation);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useLazyFetch("/api/search.json", { default: () => [], server: false }, "$WyDDCPVa65");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UPageError = _sfc_main$5;
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-Dv7Gi2xl.mjs').then((r2) => r2.default || r2));
    const nuxtApp = useNuxtApp();
...
export { ensureArray as $, o$1 as A, t$2 as B, i$1 as C, A$2 as D, s$3 as E, l$2 as F, o as G, l$3 as H, I$1 as I, createSharedComposable as J, useActiveElement as K, useRequestEvent as L, useNuxtApp as M, N$3 as N, useRuntimeConfig as O, useHead as P, useClipboard as Q, useRoute as R, useAsyncData as S, queryContent as T, useContentPreview as U, useContentDisabled as V, fetchContentNavigation as W, resolveIconName as X, get as Y, assertArray as Z, _export_sfc as _, __nuxt_component_0$4 as a, omit as a0, sortList as a1, apply as a2, withoutKeys as a3, withKeys as a4, createQuery as a5, useLazyFetch as a6, __nuxt_component_0 as a7, _sfc_main$7 as a8, __nuxt_component_2 as a9, __nuxt_component_3 as aa, __nuxt_component_0$6 as ab, useOgImageRuntimeConfig as ac, useSiteConfig as ad, _sfc_main$6 as b, createError as c, useUI as d, entry$1 as default, __nuxt_component_0$2 as e, useState as f, useId as g, useEventBus as h, appConfig as i, useDebounceFn as j, input as k, __nuxt_component_1 as l, mergeConfig as m, useInjectButtonGroup as n, looseToNumber as o, useAppConfig as p, avatar as q, getSlotsChildren as r, __nuxt_component_4 as s, nuxtLinkProps as t, useToast as u, getNuxtLinkProps as v, getSlotChildrenText as w, __nuxt_component_0$8 as x, config$6 as y, u$5 as z };
