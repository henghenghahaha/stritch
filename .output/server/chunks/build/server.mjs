...
import { $ as $fetch$1, h as createError$1, M as defuFn, N as klona, y as defu, O as withLeadingSlash, P as joinURL, x as withoutTrailingSlash, k as hash$2, Q as parseQuery, R as createDefu, S as isEqual, T as withBase, U as createHooks, V as parse, W as getRequestHeader, X as hasProtocol, Y as isScriptProtocol, C as withQuery, m as destr, Z as setCookie, _ as getCookie, a0 as deleteCookie, a1 as sanitizeStatusCode, G as withTrailingSlash, p as parseURL, v as toRouteMatcher, w as createRouter$1, z as withoutBase } from '../runtime.mjs';
...
const _routes = [
  {
    name: "course",
    path: "/course",
    component: () => import('./course-C8xwPJqu.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "dist",
    path: "/dist",
...
const layouts = {
  ...
  default: () => import('./default-CWRRUQ-w.mjs').then((m2) => m2.default || m2)
};
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender$3]]);
const useColorMode = () => {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-BP7OY8Kk.mjs').then((r2) => r2.default || r2));
    const nuxtApp = useNuxtApp();
...
export { ensureArray as $, o$1 as A, t$2 as B, i$1 as C, A$2 as D, s$3 as E, l$2 as F, o as G, l$3 as H, I$1 as I, createSharedComposable as J, useActiveElement as K, useRequestEvent as L, useNuxtApp as M, N$3 as N, useRuntimeConfig as O, useHead as P, useClipboard as Q, useRoute as R, useAsyncData as S, queryContent as T, useContentPreview as U, useContentDisabled as V, fetchContentNavigation as W, resolveIconName as X, get as Y, assertArray as Z, _export_sfc as _, __nuxt_component_0$4 as a, omit as a0, sortList as a1, apply as a2, withoutKeys as a3, withKeys as a4, createQuery as a5, __nuxt_component_0 as a6, _sfc_main$7 as a7, __nuxt_component_2 as a8, __nuxt_component_0$6 as a9, useOgImageRuntimeConfig as aa, useSiteConfig as ab, _sfc_main$6 as b, createError as c, useUI as d, entry$1 as default, __nuxt_component_0$2 as e, useState as f, useId as g, useEventBus as h, appConfig as i, useDebounceFn as j, input as k, __nuxt_component_1 as l, mergeConfig as m, useInjectButtonGroup as n, looseToNumber as o, useAppConfig as p, avatar as q, getSlotsChildren as r, __nuxt_component_4 as s, nuxtLinkProps as t, useToast as u, getNuxtLinkProps as v, getSlotChildrenText as w, __nuxt_component_0$8 as x, config$6 as y, u$5 as z };
