import { G as prefixStorage, I as useStorage, a3 as useNitroOrigin, U as withBase, C as createStorage, q as useOgImageRuntimeConfig, z as defu } from '../runtime.mjs';
...
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('./wasm.mjs').then((m) => m.default);
